...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-yellow-50 w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-80 items-center justify-center isolate z-0 mt-20">
        <motion.div
        ...
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-yellow-50 blur-2xl"></div>
